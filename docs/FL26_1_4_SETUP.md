# FL26 v1.4 — instalación y primera captura

Target actual: **SP Football Life 2026 v1.4**.
...
```text
LM AI Director 0.1.2-fl26.1.4 | OBSERVE | waiting for team context
```

Cuando FL26 determine el siguiente partido:

```text
LM AI Director 0.1.2-fl26.1.4 | OBSERVE | home:109 away:XXX
```
...
python -m lm_ai.cli --world examples/world.json --config config/fl26_1_4.json --seed 26 --output out/proposals.json
```
...
Para FL26 v1.4 necesitamos capturar evidencia propia de esa versión.
...
No copiar offsets de PES 2021 Steam, FL25, FL26 v1.1, FL26 v2.x ni otra build sin validarlos.
...
hasta que tengamos una firma estable para v1.4.
